...
def fetch_random_image():
    try:
        response = requests.get("https://api.unsplash.com/photos/random", params={"client_id": UNSPLASH_ACCESS_KEY, "query": "street photography"})
...
async def generate_image(content, author, image_data):
    try:
        ...
        max_font_size = int(image.height)  # Half the image height
